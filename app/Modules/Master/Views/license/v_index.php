<div class="x_panel">
    <div class="x_title">
        ...
        <ul class="nav navbar-right panel_toolbox">
            <li><button type="button" class="btn btn-sm btn-primary" onclick="showModal()"><i class="fa fa-plus"></i> New License</button></li>
        </ul>
                        ...
                        foreach ($data as $key => $value) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" onclick="showConfirm(<?= $value->license_id ?>)"><i class="fa fa-trash"></i></button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div id="modal_action" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <form action="<?= base_url('master/license/save') ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="license_name">License Name*</label>
                        <input type="text" class="form-control" name="license_name" id="license_name" value="" maxlength="100" tabindex="1" required>
                    </div>
